...
// restoreUser will be applied as a pre-middleware to route handlers where needed
...
// requireAuth will be applied as a pre-middleware to route handlers where needed
const requireAuth = [
  restoreUser,
